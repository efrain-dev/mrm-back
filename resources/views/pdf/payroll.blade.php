...
<header>
    ...
    <h4 class="titulo1 titulos"><strong style="margin-right: 500px">{{\Carbon\Carbon::parse($data['payroll']->start)->format('d/m/Y')}}-{{\Carbon\Carbon::parse($data['payroll']->end)->format('d/m/Y')}}</strong>  <strong>{{$data['payroll']->id}}</strong> </h4>
</header>
<main>
